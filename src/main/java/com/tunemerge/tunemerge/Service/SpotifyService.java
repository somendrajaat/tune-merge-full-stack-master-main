...
public class SpotifyService {
    ...
    public String getProfile(String accessToken) {
        ...
        /*
         * yeh wala code spotify ke documentation per tha udher se convert karke chipka
         * diya h
        ...
        ResponseEntity<String> response = restTemplate.exchange(SPOTIFY_PROFILE_URL, HttpMethod.GET, entity,
                String.class);
        if (response.getStatusCode() == HttpStatus.OK) {
            return response.getBody();
        } else {
